...
public class TodoService {
    ...
    //컨트롤러(DTO)에서 값을 전달 받아서 Repository(Entity)작업
    //Repository(Entity)로 값을 받아서 컨트롤러(DTO)로 전달
    ...
    /*-----------------------------------
        ...
        인수 : 페이지번호
        결과 : Page<TodoDTO>
        내용 : 페이지번호를 받아서 테이블의 모든 데이터를 읽어와서 컨트롤러에 전달
    -----------------------------------*/
    public Page<TodoDTO> list(Pageable page) {
        ...
        //Entities에서 하나의 entity를 읽어서 data에 저장
    ...
    /*----------------------------------
        함수명 : TodoDTO read(Intger id)
        인수 : 기본키 일렬번호
        결과 : TodoDTO
        내용 : 테이블의 해당번호를 조회해서 데이터를 읽어와서 컨트롤러에 전달
    ----------------------------------*/
